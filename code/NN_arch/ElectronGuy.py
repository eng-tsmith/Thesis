...
def build_model(args, input_shape):
    ...
    conv2 = Conv2D(16, (3, 3), strides=(1, 1), padding='same', kernel_regularizer=l2(1e-5), name='conv_layer_2')(max1)
    act2 = Activation('relu', name='act_layer_2')(conv2)
    max2 = MaxPooling2D(pool_size=(2, 2), name='pool_layer_2')(act2)

    conv3 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', kernel_regularizer=l2(1e-5), name='conv_layer_3')(max2)
    act3 = Activation('relu', name='act_layer_3')(conv3)
    conv4 = Conv2D(32, (3, 3), strides=(1, 1), padding='same', kernel_regularizer=l2(1e-5), name='conv_layer_4')(act3)
    ...
    conv5 = Conv2D(64, (3, 3), strides=(1, 1), padding='same', kernel_regularizer=l2(1e-5), name='conv_layer_5')(dropout1)
    act5 = Activation('elu', name='act_layer_5')(conv5)
    conv6 = Conv2D(64, (3, 3), strides=(1, 1), padding='same', kernel_regularizer=l2(1e-5), name='conv_layer_6')(act5)
    ...
    conv7 = Conv2D(128, (3, 3), strides=(1, 1), padding='same', kernel_regularizer=l2(1e-5), name='conv_layer_7')(dropout2)
    act7 = Activation('elu', name='act_layer_7')(conv7)
    conv8 = Conv2D(128, (3, 3), strides=(2, 2), padding='same', kernel_regularizer=l2(1e-5), name='conv_layer_8')(act7)
    ...
    dense1 = Dense(128, activation='elu', kernel_regularizer=l2(1e-5), name='fc_layer_1')(flat)
    dropout4 = Dropout(0.5, name='dropout_layer_4')(dense1)
    dense2 = Dense(96, activation='elu', kernel_regularizer=l2(1e-5), name='fc_layer_2')(dropout4)
